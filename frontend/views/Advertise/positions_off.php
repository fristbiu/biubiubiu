            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                           无效职位 <span>（共<i style="color:#fff;font-style:normal" id="positionNumber"><?=$count?></i>个）</span>                        </h1>
                    </dt>
                    <dd>
                    		                    	<form id="searchForm">
			                	...
			                	<ul class="reset my_jobs">
		                                    ...
		                                    <h3>
		                                        <a target="_blank" title="<?=$v['advertise_name']?>" href=""><?=$v['advertise_name']?></a> 
		                                       	...
		                                       	<a class="offline" data-id="<?=$v['advertise_id']?>" href="javascript:void(0)">恢复上线</a>                      
