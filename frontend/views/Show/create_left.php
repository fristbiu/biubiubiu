<div class="sidebar">
    <a class="btn_create" href="?r=show/create">发布新职位</a>
    <dl class="company_center_aside">
        ...
        <dd>
            <a href="?r=show/have_refus">待定简历</a>
        </dd>
        <dd>
            <a href="?r=show/haveNoticeResumes">已通知面试简历</a>
        </dd>
        <dd class="current">
            <a href="?r=show/haveRefuseResumes">不合适简历</a>
        </dd>
        <dd class="btm">
            <a href="?r=show/autoFilterResumes">自动过滤简历</a>
        </dd>
    </dl>
    <dl class="company_center_aside">
        <dt>我发布的职位</dt>
        <dd>
            <a href="?r=show/positions">有效职位</a>
        </dd>
        <dd>
            <a href="?r=show/positions">已下线职位</a>
        </dd>
    </dl>
